      ...
      <div className="p-6 lg:p-8 space-y-6">
        <motion.div initial={{ y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
          <div className="flex items-center gap-3 mb-2">
            <div className="w-9 h-9 rounded-xl bg-brand-indigo/15 border border-brand-indigo/30 flex items-center justify-center">
              <Trophy className="w-5 h-5 text-brand-indigo-light" />
            </div>
            <h1 className="font-display text-2xl font-bold text-white">Görev & Ödül Yönetimi</h1>
          </div>
          <p className="text-muted-foreground">
            Fuar içi görevler oluşturun, ödüller tanımlayın ve Altın QR'ları standlara atayın.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-sm text-muted-foreground max-w-sm">
            Ziyaretçilerin tamamlaması için fuar içi görevler ve ödüller oluşturun.
          </p>
        </motion.div>
      </div>
    </DashboardShell>
