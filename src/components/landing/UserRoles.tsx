...
const ROLES = [
  ...
  },
  {
    ...
    color: "violet",
    label: "Ziyaretçi",
    tagline: "Gez, Rozet Kazan, Ücretsiz Bilet Al",
    description:
      "AI sana uygun firmaları önerir. Stantları gez, rozet kazan, puan biriktir. 500 puan = bir sonraki fuara ücretsiz giriş.",
    features: [
