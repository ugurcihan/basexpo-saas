...
const ROLES = [
  {
    ...
    features: [
      ...
      "Push bildirimi gönder — CEO konuşması anında tüm katılımcılara",
      "Oyunlaştırma yönetimi — loot box, ödül havuzu, Altın QR çekilişi",
    ],
  ...
  },
  {
    ...
    color: "violet",
    label: "Ziyaretçi",
    tagline: "Gez, Puan Kazan, Loot Box Aç",
    description:
      "AI sana uygun firmaları önerir. Stantları gez, puan kazan, loot box aç. Organizatörün belirlediği ödüllere dönüştür.",
    features: [
      "Kişisel QR bilet & rozet",
      "AI firma önerileri",
      "Loot box aç, Altın QR yakala",
      "Fuar / Türkiye / Dünya liderlik tablosu",
      "Toplantı & networking",
    ],
